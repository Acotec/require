...
var GM_SuperValue = new function () {
    ...
    if (typeof GM_setValue != "function") ReportError ('This library requires Greasemonkey/TamperMonkey! GM_setValue is missing.');
    if (typeof GM_getValue != "function") ReportError ('This library requires Greasemonkey/TamperMonkey! GM_getValue is missing.');
